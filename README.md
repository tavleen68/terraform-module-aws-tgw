...
| <a name="input_namespace"></a> [namespace](#input\_namespace) | namespace to segregate the resources from other environment and used in the naming convention | `string` | `null` | no |
...
| <a name="input_stage"></a> [stage](#input\_stage) | stage to segregate the resources from other environment and used in the naming convention | `string` | `null` | no |
