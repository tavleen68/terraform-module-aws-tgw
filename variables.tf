...
#poc=environment
#cicm=project_name
#awsresource=resource_name
#ex=ot-eucen1-poc-cicm-transit-gateway
#${var.namespace}-${var.region_name}-${var.environment}-${var.project_name}

locals {
  initial_id = "${var.namespace}-${var.region_name}-${var.environment}-${var.project_name}"
}
